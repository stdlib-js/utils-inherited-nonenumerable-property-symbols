...
```javascript
inheritedNonEnumerablePropertySymbols = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-inherited-nonenumerable-property-symbols@v0.2.0-umd/browser.js' )
```
