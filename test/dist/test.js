...
var inheritedNonEnumerablePropertySymbols = require( './../../dist' ); // eslint-disable-line id-length
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof inheritedNonEnumerablePropertySymbols, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function throws an error if not provided a positive integer for the inheritance level', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			inheritedNonEnumerablePropertySymbols( {}, value );
		};
	}
});

tape( 'the function returns an array of an object\'s inherited non-enumerable symbol properties', function test( t ) {
	var expected;
	var actual;
	var syms;
	var obj;
	...
	actual = inheritedNonEnumerablePropertySymbols( obj );
...
tape( 'the function returns an array of an object\'s inherited non-enumerable symbol properties (multiple inheritance)', function test( t ) {
	var expected;
	var actual;
	var syms;
	var obj;
...
tape( 'the function supports limiting the inheritance level', function test( t ) {
	...
	actual = inheritedNonEnumerablePropertySymbols( obj, 1 );
...
tape( 'the function returns an empty array if provided `null` or `undefined`', function test( t ) {
	...
	for ( i = 0; i < values.length; i++ ) {
		actual = inheritedNonEnumerablePropertySymbols( values[ i ] );
